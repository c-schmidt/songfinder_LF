...
- The author Vidar has only tested it under Linux. But user feedback seems to
indicate success under various Windows versions and Mac OS X.
Adaption to the new web service API for love and hate rating was done by Gabi on a Windows environment.
